...
<body>
	<table>
		...
		<tr>
			<td colspan="3" class='SectionHeading'>PHP extensions</td>
		</tr>
		...
		<tr>
			...
			<td>Used to render result images.</td>
		</tr>
		...
		<tr>
			...
			<td>Only required if using MS SQL.</td>
		</tr>
		...
		<tr>
			...
			<td>Only required if using mysql.</td>
		</tr>
		...
		<tr>
			...
			<td>Only required if using sqlite.</td>
		</tr>
		...
		<tr>
			...
			<td>Only required if using postgresql.</td>
		</tr>


		<tr>
			<td colspan="3" class='SectionHeading'>Database check</td>
		</tr>
		<tr>
			<td>Connecting to DB</td>
			<td>
				<?php
				$pdo = getPdo(true);
