			...
			<div>
				...
				<div class="bg-glass rounded-2xl p-8 w-full mt-16">
					<ul class="flex flex-col gap-8">
						<li><button class="bg-gradient py-4 px-16 mx-auto flex items-center justify-center rounded-2xl border-2 text-sm w-[200px]"><a href="/speed-test/index.php"><img src="./assets/Home Page.png" alt="home" class="inline-block h-4"> Home</a></button></li>
